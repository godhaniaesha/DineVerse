...
router.post('/orders/checkout-details/:orderId', UserAuth,  waiterAuth, createBillingPaymentIntent);
router.post('/orders/confirm-checkout/:orderId', UserAuth,  waiterAuth, confirmBillingAndCheckout);
