        ...
        <footer className="z_footer">
            <div className="container">
                <div className="row g-4">
                    {/* Brand & About */}
                    <div className="col-lg-4 col-md-6  z_footer_col">
                    ...
                    {/* Quick Links */}
                    <div className="col-lg-2 col-md-6 col-6 z_footer_col">
                    ...
                    {/* Hours */}
                    <div className="col-lg-3 col-md-6 col-6 z_footer_col">
                    ...
                    {/* Contact Info */}
                    <div className="col-lg-3 col-md-6 col-12 z_footer_col">
