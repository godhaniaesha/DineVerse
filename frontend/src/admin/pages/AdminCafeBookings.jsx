...
export default function AdminCafeBookings({ title = "Cafe Bookings", sub = "Manage all cafe table reservations." }) {
  ...
  return (
    <div className="ad_page">
      <div className="rooms__header"><div><h2 className="ad_h2">{title}</h2><p className="ad_p">{sub}</p></div><button className="rooms__add_btn" onClick={openAdd}>Add Booking</button></div>
