...
const TABLES_STORAGE_KEY = "admin-cafe-tables";

const INITIAL_TABLES = [
    { id: 1, tableNo: "T1", area: "Cafe", capacity: 4, status: "reserved", waiter: "" },
    { id: 2, tableNo: "T2", area: "Cafe", capacity: 4, status: "occupied", waiter: "John Doe" },
    { id: 3, tableNo: "T3", area: "Cafe", capacity: 6, status: "reserved", waiter: "" },
];

const EMPTY_FORM = { tableNo: "", area: "Cafe", capacity: "2", status: "reserved", phone: "" };
...
export default function CafeBookTable() {
    ...
    return (
        <div className="ad_page">
            <div className="rooms__header">
                <div><h2 className="ad_h2">Cafe Booked Tables</h2><p className="ad_p">Manage cafe table bookings.</p></div>
            ...
            <div className="ad_table_wrap">
                <table className="ad_table">
                    ...
                    <tbody>
                        {rows
                            .filter((row) => row.area === "Cafe" && (row.status === "reserved" || row.status === "occupied"))
                            .map((row) => (
                                <tr key={row.id}>
