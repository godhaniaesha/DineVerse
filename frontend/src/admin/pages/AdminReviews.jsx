...
const DATA = [
  { id: 1, name: "Aarav", rating: 5, message: "Great ambience and food.", date: "2026-04-01", status: "Approved" },
  { id: 2, name: "Mia", rating: 3, message: "Service was a bit slow.", date: "2026-04-01", status: "Pending" },
];
const EMPTY = { name: "", rating: "5", message: "", date: "", status: "Pending" };
...
export default function AdminReviews() {
  ...
  const save = () => {
    if (!form.name.trim() || !form.message.trim() || !form.date) return;
