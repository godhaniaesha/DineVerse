  ...
  const getRoomTypes = useCallback(async () => {
    try {
      ...
      if (data.success) {
        ...
        return { success: false, error: data.message || data.message || "Failed to fetch room types" };
      }
    } catch (error) {
  ...
  const addRoomType = useCallback(async (roomTypeData) => {
    try {
      ...
      if (data.success) {
        ...
        return { success: false, error: data.message || data.message || "Failed to add room type" };
      }
    } catch (error) {
  ...
  const updateRoomType = useCallback(async (id, roomTypeData) => {
    try {
      ...
      if (data.success) {
        ...
        return { success: false, error: data.message || data.message || "Failed to update room type" };
      }
    } catch (error) {
  ...
  const deleteRoomType = useCallback(async (id) => {
    try {
      ...
      if (data.success) {
        ...
        return { success: false, error: data.message || data.message || "Failed to delete room type" };
      }
    } catch (error) {
  ...
  const getRooms = useCallback(async () => {
    try {
      ...
      if (data.success) {
        ...
        return { success: false, error: data.message || data.message || "Failed to fetch rooms" };
      }
    } catch (error) {
  ...
  const addRoom = useCallback(async (roomData) => {
    try {
      ...
      if (data.success) {
        ...
        return { success: false, error: data.message || data.message || "Failed to add room" };
      }
    } catch (error) {
  ...
  const updateRoom = useCallback(async (id, roomData) => {
    try {
      ...
      if (data.success) {
        ...
        return { success: false, error: data.message || data.message || "Failed to update room" };
      }
    } catch (error) {
  ...
  const deleteRoom = useCallback(async (id) => {
    try {
      ...
      if (data.success) {
        ...
        return { success: false, error: data.message || data.message || "Failed to delete room" };
      }
    } catch (error) {
  ...
  const searchRooms = useCallback(async (search, type, status) => {
    try {
      ...
      if (data.success) {
        ...
        return { success: false, error: data.message || data.message || "Failed to search rooms" };
      }
    } catch (error) {
