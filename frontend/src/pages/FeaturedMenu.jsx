...
const MENU_ITEMS = [
  ...
  },
  {
    ...
    desc: "Creamy burrata, heirloom tomatoes, aged balsamic, basil oil.",
    price: "18",
    category: "restaurant",
    categoryLabel: "Restaurant",
    badge: null,
  ...
  },
  {
    id: 6,
    name: "Cardamom Latte",
    desc: "House-spiced espresso, steamed oat milk, cardamom caramel drizzle.",
    price: "8",
    category: "cafe",
    categoryLabel: "Café",
    badge: "popular",
  ...
  },
  {
    ...
    desc: "Herb-crusted fillet, saffron beurre blanc, fennel, cherry tomatoes.",
    price: "34",
    category: "restaurant",
    categoryLabel: "Restaurant",
    badge: "new",
  ...
  },
  {
    ...
    desc: "House elderflower cordial, prosecco, cucumber, fresh mint.",
    price: "13",
    category: "bar",
    categoryLabel: "Bar",
    badge: null,
